...
def check_pr_title(title):
    if not re.match(title_regex, title):
        ...
        print("Valid title examples: natIPs: T99999: make IPsec secure, T99999: make IPsec secure")
        sys.exit(1)
...
def check_commit_message(title):
    if not re.match(commit_regex, title):
        ...
        print("Valid comment message examples: natIPs: T99999: make IPsec secure, T99999: make IPsec secure")
        sys.exit(1)
